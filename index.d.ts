declare class JSZM {
  ...
  /**
   * A generator function you define, which will be
  ...
  /**
   * Normally false. Set it to true to tell the game that it is a Tandy computer;
   * this affects some games.
   */
  isTandy: boolean;

  /**
   * A generator function that you must define, and
  ...
  /**
   * A generator function which you must define yourself, and
  ...
  /**
   * A generator function you can optionally define. When the
  ...
  /**
   * A generator function you can define yourself, which is
  ...
  /**
   * A generator function. Call it to run the program from the
  ...
  /**
   * A generator function you can define yourself, and is called
  ...
  /** 
   * Normally null. You can set it to a generator function
  ...
  /** 
   * Normally null, but can be a generator
  ...
  /**
   * A normal function. Calling it will attempt to verify the
